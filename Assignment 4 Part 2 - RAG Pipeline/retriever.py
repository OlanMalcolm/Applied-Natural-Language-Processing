...
class Retriever:
    ...
    def splitDocuments(self, documents, chunk_size=700, chunk_overlap=50):
        ...
        To pass the local test, use RecursiveCharacterTextSplitter
        You are free to explore other text_splitters to achieve the best score when answering the RAG Questions.
    ...
    def createRetriever(self, document_chunks, num_chunks_to_return=4):
        ...
        To pass the local test, use HuggingFace's BAAI/bge-small-en-v1.5 for the embeddings.
        You are free to explore other embedding models to achieve the best score when answering the RAG Questions.
